...
export const landingContent: LandingContent = {
  ...
  about: {
    ...
    philosophy:
      "القوة ليست جسدية فقط. إنها الانضباط للحضور، والصبر للتقدم، والصدق في تصحيح الأداء. تدريسي مبني على الهيكل والمساءلة والنتائج التي تشعر بها.",
    trustBullets: [
      "سنوات من التدريب والتدريب في الكاليستينكس",
  ...
  offer: {
    ...
    summary:
      "تجربة تدريب مخصصة بالكامل مصممة حسب مستهلك وأهدافك وجدولك الزمني. لا قوالب جاهزة. لا تخمينات. فقط مسار واضح للأمام.",
    deliverables: [
    ...
    items: [
      {
        ...
        body:
          "جئت بالكاد أستطيع عمل 5 تمارين سحب. الهيكل والتغذية الراجعة صنعتا كل الفرق. بعد 8 أسابيع حققت أول عضلة أب.",
      ...
      },
      {
        ...
        body:
          "كنت أتدرب بشكل عشوائي لسنوات. وجود مدرب يبرمج أسبوعي بالفعل ويتحقق من شكلي غيّر كل شيء.",
        attribution: "— س.ك.، رياضي متوسط",
      },
      {
        type: "transformation",
        headline: "نتائج حقيقية قادمة",
        body:
          "نتائج قبل وبعد للرياضيين المدربين ستظهر هنا مع نمو البرنامج.",
        attribution: "جراڤيكس كاليستينكس",
        metric: "قريبًا",
      },
    ],
  },
    ...
    items: [
      {
        ...
        answer:
          "نعم. البرنامج يتكيف مع مستواك الحالي. إذا كنت بالكاد تستطيع عمل تمرين ضغط، نبدأ من هناك. التقدم مدمج في الخطة حتى لا تضيع أو تُربك.",
      },
      {
        question: "ما المعدات التي أحتاجها؟",
        answer:
          "الحد الأدنى. شريط عقلة ومساحة أرضية تغطي معظم الأساس. مع تقدمك، الحلقات أو القضبان المتوازية تساعد، لكنها ليست مطلوبة للبدء.",
      },
      {
      ...
      {
        question: "هل تقدمون إرشادات تغذية؟",
        answer:
          "التغذية ليست المحور الأساسي، لكني أقدم إرشادات أساسية حول التغذية للقوة والتعافي. خطط الوجبات الكاملة خارج النطاق، لكنك لن تُترك للتخمين.",
      },
      {
        question: "ما مدى سرعة رؤية التقدم؟",
        answer:
          "المبتدئون يلاحظون عادة تحسن القوة خلال 2 إلى 4 أسابيع. المعالم المهارية مثل العضلات الأمامية أو الوقوف على اليدين تعتمد على نقطة بدايتك لكنها تُحقق عادة خلال 6 إلى 12 أسبوعًا من العمل المستمر.",
      },
    ],
  },
  contact: {
    ...
    subtitle:
      "املأ النموذج أدناه وسأعود إليك لمناقشة أهدافك وما إذا كان هذا البرنامج مناسبًا لك.",
